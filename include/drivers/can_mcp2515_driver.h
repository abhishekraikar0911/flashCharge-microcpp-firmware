...
/**
 * @file can_mcp2515_driver.h
 * @brief MCP2515 SPI CAN Driver for Vehicle BMS Communication
 * @author Rivot Motors
 * @date 2025
 */
...
{
    /**
     * @brief Initialize MCP2515 CAN driver
     * @return true if initialization successful
     */
    bool init();

    /**
     * @brief Deinitialize MCP2515 driver
    ...
    /**
     * @brief Check if MCP2515 is healthy (receiving messages)
